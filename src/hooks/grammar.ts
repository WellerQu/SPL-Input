...
// #region 手动构建的语法树
const commaAndFieldNode: (nextNode?: GrammarNode) => GrammarNode = (nextNode = {}) => ({
  [WordType.identifier]: () => ({
    ...nextNode,
...
const completionNode: (nextNode?: GrammarNode) => GrammarNode = (nextNode = {}) => ({
  ...
  [WordType.fields]: () => ({
    [WordType.whitespace]: () => ({
      [WordType.leftSquareBracket]: () => ({
        ...
        [WordType.whitespace]: () => commaAndFieldNode(({
          [WordType.rightSquareBracket]: () => ({
            [WordType.whitespace]: () => pipeNode(commandNode())
          })
        }))
...
const connecterNode: (nextNode?: GrammarNode) => GrammarNode = (nextNode = {}) => ({
  [WordType.connector]: () => ({
    [WordType.whitespace]: () => ({
      ...fieldNode(),
      ...quoteNode(),
...
const nextQuoteNode: (nextNode?: GrammarNode) => GrammarNode = (nextNode = {}) => ({
  [WordType.whitespace]: () => ({
    [WordType.identifier]: () => ({
...
const nextFieldNode: (nextNode?: GrammarNode) => GrammarNode = (nextNode = {}) => ({
  [WordType.whitespace]: () => ({
    ...fieldNode(nextNode),
